...
[Temp]$ project-new --named example --version 1.0.0-SNAPSHOT --top-level-package org.demo --type spring-boot
----
+
And that's it!
...
[source,java]
----
project-new --named example --version 1.0.0-SNAPSHOT --top-level-package org.demo --type spring-boot --spring-boot-version 1.4.1
----
