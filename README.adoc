...
If you want to use your own Spring Boot YAML config file containing the dependencies/starters to be selected for your project when it will be created with the command `project-new`,
