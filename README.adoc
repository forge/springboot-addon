...
This command will allow you to generate a REST controller class exposing a `/greeting` endpoint and generating a response using the `Greeting` model class.
The class contains 2 fields; id and content.
+
