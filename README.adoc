...
+
The content of this file will be unzipped locally according under the directory as defined by the `--named` parameter.
+
When no Spring Boot starters / dependencies is defined, then `start.spring.io` will return a project containing
